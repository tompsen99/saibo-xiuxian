...
(function () {
  ...
  function displayRoom(room) {
    ...
    if (room.exits) {
      var exitNames = { north: '北', south: '南', east: '东', west: '西', up: '上', down: '下', southeast: '东南', northeast: '东北', southwest: '西南', northwest: '西北' };
  ...
  // 用CSS代替JS防止双击缩放（避免阻止点击事件）
  // touch-action: manipulation 已在CSS中设置
